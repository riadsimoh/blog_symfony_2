...
class User extends \App\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\User' . "\0" . 'id', '' . "\0" . 'App\\Entity\\User' . "\0" . 'email', '' . "\0" . 'App\\Entity\\User' . "\0" . 'roles', '' . "\0" . 'App\\Entity\\User' . "\0" . 'firstName', '' . "\0" . 'App\\Entity\\User' . "\0" . 'password', '' . "\0" . 'App\\Entity\\User' . "\0" . 'twitterUsername', '' . "\0" . 'App\\Entity\\User' . "\0" . 'apiTokens'];
        }
     ...
     * {@inheritDoc}
     */
    public function setTwitterUsername(?string $twitterUsername): \App\Entity\User
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTwitterUsername', [$twitterUsername]);
     ...
     * {@inheritDoc}
     */
    public function addApiToken(\App\Entity\ApiToken $apiToken): \App\Entity\User
    {
     ...
     * {@inheritDoc}
     */
    public function removeApiToken(\App\Entity\ApiToken $apiToken): \App\Entity\User
    {
