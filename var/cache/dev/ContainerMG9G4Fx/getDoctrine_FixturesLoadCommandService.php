...
$a->addFixtures([0 => new \App\DataFixtures\ArticleFixtures(), 1 => new \App\DataFixtures\CommentFixture(), 2 => new \App\DataFixtures\TagFixture(), 3 => new \App\DataFixtures\UserFixture(($this->services['security.password_encoder'] ?? $this->load('getSecurity_PasswordEncoderService.php')))]);
