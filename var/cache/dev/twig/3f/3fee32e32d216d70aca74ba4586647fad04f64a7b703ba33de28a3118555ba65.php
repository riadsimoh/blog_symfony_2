...
class __TwigTemplate_ab4d2ca12e2cb29da1982b61054ea6be14364a0855c35ade87f3a8eecb916b03 extends \Twig\Template
{
    private $source;
...
";
    ...
    : \$view['form']->humanize(\$name); } ?>
<button type=\"<?php echo isset(\$type) ? \$view->escape(\$type) : 'button' ?>\" <?php echo \$view['form']->block(\$form, 'button_attributes') ?>><?php echo \$view->escape(false !== \$translation_domain ? \$view['translator']->trans(\$label, array(), \$translation_domain) : \$label) ?></button>
", "@Framework/Form/button_widget.html.php", "/home/riad/symfony_projects/the _spacebar_security/vendor/symfony/framework-bundle/Resources/views/Form/button_widget.html.php");
    }
}
