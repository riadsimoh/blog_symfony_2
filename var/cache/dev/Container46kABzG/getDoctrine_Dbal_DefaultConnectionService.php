...
$a->setSQLLogger($b);
$d = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\ServiceLocator(['doctrine.orm.default_listeners.attach_entity_listeners' => function () {
