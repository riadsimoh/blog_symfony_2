...
return $this->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\ServiceLocator(['App\\Command\\ArticleStatsCommand' => function (): \App\Command\ArticleStatsCommand {
    return ($this->privates['App\Command\ArticleStatsCommand'] ?? $this->load('getArticleStatsCommandService.php'));
...
}, 'maker.auto_command.make_docker_database' => function (): \Symfony\Bundle\MakerBundle\Command\MakerCommand {
    return ($this->privates['maker.auto_command.make_docker_database'] ?? $this->load('getMaker_AutoCommand_MakeDockerDatabaseService.php'));
...
}, 'maker.auto_command.make_message' => function (): \Symfony\Bundle\MakerBundle\Command\MakerCommand {
    return ($this->privates['maker.auto_command.make_message'] ?? $this->load('getMaker_AutoCommand_MakeMessageService.php'));
}, 'maker.auto_command.make_messenger_middleware' => function (): \Symfony\Bundle\MakerBundle\Command\MakerCommand {
    return ($this->privates['maker.auto_command.make_messenger_middleware'] ?? $this->load('getMaker_AutoCommand_MakeMessengerMiddlewareService.php'));
...
}, 'maker.auto_command.make_reset_password' => function (): \Symfony\Bundle\MakerBundle\Command\MakerCommand {
    return ($this->privates['maker.auto_command.make_reset_password'] ?? $this->load('getMaker_AutoCommand_MakeResetPasswordService.php'));
