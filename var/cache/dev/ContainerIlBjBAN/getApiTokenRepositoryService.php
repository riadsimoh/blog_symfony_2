...
// Returns the private 'App\Repository\ApiTokenRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ApiTokenRepository.php';

return $this->privates['App\Repository\ApiTokenRepository'] = new \App\Repository\ApiTokenRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
